...
::eof::
------------------------------------------
-- [1] Иерузалимски.Программирование на языке Lua.3ed.2014  (Lua5.2)
-- [2] Programming in Lua.by Roberto Ierusalimschy.4ed.2016 (Lua5.3)
-- [3] Wrox.Beginning.Lua.Programming.by Kurt Jung,Aaron Brown.2007 (Lua5.1.1)
]
